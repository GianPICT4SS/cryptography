...
def main():
    ...
    with open("ciphertexts/cryptogram01.txt","r") as text_file:
        cryptogram = text_file.read()

    
    print(cryptogram)
    print(monogram_ranking(cryptogram, 4))
    print(digram_ranking(cryptogram, 4))
    print(trigram_ranking(cryptogram, 4))
